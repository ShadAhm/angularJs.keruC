...
(function () {
    angular.module('keruCDemo', ['keruC']);
})();

angular.module('keruCDemo')
    .controller('mainController', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.isExpandSettings = false; 
        $scope.expandSettings = function() { $scope.isExpandSettings = !$scope.isExpandSettings }
        ...
        $scope.settings = {
            ...
            showRowLabel: false,
            showSeatLabel: true,
            maintainSquareRatio: true
        };

        // node events demonstrating callbacks within keruc
